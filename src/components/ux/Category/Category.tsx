...
const Category: React.FC<IProps> = ({ currentCategory, setCurrentCategory, categories, animationKey }) => {
    return <div className={ css.category__container } key = { animationKey }>
