  ...
  return (
    <section className="bg-black flex justify-center items-center gap-3 flex-wrap">
      <div className="flex flex-col justify-center items-start p-5 gap-5">
        ...
        <h3 className="text-4xl text-white">Enhance Your Music Experience</h3>
        <ul className="flex justify-center items-center flex-wrap gap-5">
          <li className="bg-white  rounded-[50px] p-2 text-black text-lg">
            23 Hours
          </li>
          <li className="bg-white  rounded-[50px] p-2 text-black text-lg">
            05 Days
        ...
        <Link
          to="/"
          className="rounded-md max-w-[150px] w-full min-h-[50px] bg-green-400 flex justify-center items-center text-white hover:scale-105 transition-all"
        >
          Buy Now !
        </Link>
      </div>
